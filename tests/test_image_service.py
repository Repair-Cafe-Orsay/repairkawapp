...
from repairkawapp.services.image_service import process_user_photo, MAX_PHOTO_BYTES
...
def test_process_valid_image(tmp_path):
    ...
    fn, err = process_user_photo(raw, str(tmp_path), user_id=42, form_get=lambda k, d=None: {
        'crop_x': '10', 'crop_y': '15', 'crop_w': '200', 'crop_h': '150'
    }.get(k, d))
    assert err is None
